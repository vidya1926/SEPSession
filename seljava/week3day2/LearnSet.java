...
public class LearnSet {
	...
	public static void main(String[] args) {
        ...
        System.out.println("Duplicated names are : "+s5);        
        System.out.println("Unique names are :" +s);
		
		  Set <String> set=new LinkedHashSet<String>(); set.add("Renu");
		  set.add("Somu"); set.add("Adam"); set.add("Ben"); set.add("James");
		  set.add("Charlie");
		  
		  
		  boolean removeAll = set.removeAll(s); 
		  System.out.println(removeAll);
		  System.out.println(set); set.add("vidya");
